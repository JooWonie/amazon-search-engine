...
<header id="header" class="header">
	<div class="container">
		<a href="/" class="logo"><?php echo $lang[0] ?></a>
		...
		<span class="site-nav">
			...
			<nav class="megamenu">
				<ul class="nav-menu">
					...
					<li class="nav-item home"><a href="/"><span class="label"><i class="icon home"></i><span class="txt"><?php echo $lang[1] ?></span></span></a></li>
					<!-- <li class="nav-item rec"><a href="./recommend.html"><span class="label"><i class="icon star"></i><span class="txt"><?php echo $lang[2] ?></span></span></a></li> -->
					<li class="nav-item cat dropdown">
						<a class="hdmenu" href="/category"><span class="label"><i class="icon cat"></i><span class="txt"><?php echo $lang[3] ?></span></span></a>
					...
					<li class="nav-item spcat"><a href="#menu"><span class="label"><i class="icon cat"></i><span class="txt"><?php echo $lang[110] ?></span></span></a></li>
				</ul>
				<div class="clear"></div>
			</nav>
		...
		<span class="right-nav">
			<div id="src-action" class="src-action"><span><?php echo $lang[111] ?></span></div>
<!--
			<a class="nav-signup nav-link" href="http://www.minnano-shopping.com/signup">Sign Up</a>
			<a class="nav-login nav-link" href="http://www.minnano-shopping.com/login">Log In</a>
-->
			<div id="search">
				<form method="get" action="./search">
					<div>
						<input id="srcbx" type="text" name="query" class="inputTxt" placeholder="<?php echo $lang[112] ?>" value="">
						<input id="srcbtn" type="submit" class="searchBtn" value="Search">
					</div>
				</form>
				<div id="src-cancel" class="src-cancel"><span><?php echo $lang[113] ?></span></div>
				<div class="clear"></div>
			</div>
		</span>
