	...
	<body><div id="page">
		...
		<article>
			...
			<div class="container index">
				...
				<ol id="owl-rec" class="products owl-carousel">
				<?php 
				if ($dvd_file) {
					include $dvd_file;
				} 
				...
				<ol id="owl-rec2" class="products owl-carousel">
				<?php 
				if ($elc_file) {
					include $elc_file;
				} 
				...
				<ol id="owl-rec3" class="products owl-carousel">
				<?php 
				if ($mp3_file) {
					include $mp3_file;
				} 
				...
				<ol id="owl-rec4" class="products owl-carousel">
				<?php 
				if ($books_file) {
					include $books_file;
				} 
