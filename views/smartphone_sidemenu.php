<!-- Smartphone sidemenu -->
<nav id="menu" class="sidemenu">
<ul>
<li><a href="/"><?php echo $lang[1] ?></a></li>
<li><a href="/category"><?php echo $lang[3] ?></a></li>

<li class="Label"><?php echo $lang[3] ?></li>
<li>
	<span><?php echo $lang[4] ?></span>
	<ul>
...
<!--
<li class="Label"><?php echo $lang[104] ?></li>
<li><a href="#"><?php echo $lang[105] ?></a></li>
<li><a href="#"><?php echo $lang[106] ?></a></li>
-->
</ul>
